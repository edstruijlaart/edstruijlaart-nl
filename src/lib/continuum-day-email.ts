...
// Ingelaste podcast (11 sep): laatste oproep + verwachtingsmanagement, in de bevestiging vanaf 11 sep.
...
${bgActieHtml}
<p>Luister ook even <a href="${PODCAST_URL}">deze korte podcast</a>: daarin vertel ik wat je op de dag kunt verwachten.</p>
${tourHtml}
<p>Tot snel!<br />Ed</p>
${voorwaardenHtml}
`;
...
Luister ook even deze korte podcast, daarin vertel ik wat je op de dag kunt verwachten: ${PODCAST_URL}
...
${verlotingHtml}
${bgActieHtml}
<p><strong>Luister nog even dit:</strong> in <a href="${PODCAST_URL}">deze korte podcast</a> vertel ik in zeven minuten wat je morgen kunt verwachten, en vooral wat niet. Dan kom je met het juiste plaatje.</p>
...
Luister nog even dit: in deze korte podcast vertel ik in zeven minuten wat je kunt verwachten, en vooral wat niet: ${PODCAST_URL}
