...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: 'Boek een huiskamerconcert met Ed Struijlaart. Een intieme avond vol muziek en verhalen bij jou thuis. Geschikt voor 20 tot 80 personen.',
    content: [
      ...
      'Een huiskamerconcert is geschikt voor groepen van 20 tot 80 personen. Ed brengt zijn eigen geluidsinstallatie mee, zodat je je nergens zorgen over hoeft te maken. Het enige wat je nodig hebt is een ruimte, stoelen en een publiek.',
  ...
  },
  {
    ...
    description: 'Wil je een unieke muzikale avond bij jou thuis? Boek Ed Struijlaart voor een huiskamerconcert. Geschikt voor 20 tot 80 personen.',
    content: [
      ...
      'Praktische informatie: een huiskamerconcert duurt ongeveer anderhalf tot twee uur, inclusief pauze. Ed verzorgt zelf de complete geluidsinstallatie. Het enige wat jij hoeft te regelen is een ruimte en een enthousiast publiek van 20 tot 80 personen.',
